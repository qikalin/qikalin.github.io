...
- ``Cognitive Computation`` ***Disentangling User Cognitive Intent with Causal Reasoning for Knowledge-Enhanced Recommendation***. <br>Hongcai Xu, Junpeng Bao, ***Qika Lin***, Lifang Hou, Feng Chen. [[Paper]](https://link.springer.com/article/10.1007/s12559-024-10321-0)
...
## 2022
- ```SIGIR 2022``` ***Incorporating Context Graph with Logical Reasoning for Inductive Relation Prediction***. <span style="color:red">[CCF-A]</span><br>***Qika Lin***, Jun Liu, Fangzhi Xu, Yudai Pan, Yifan Zhu, Lingling Zhang, Tianzhe Zhao. [[Paper]](https://dl.acm.org/doi/10.1145/3477495.3531996) [[Code]](https://github.com/qikalin/ConGLR) 
- ```SIGIR 2022``` ***Logiformer: A TwoBranch Graph Transformer Network for Interpretable Logical Reasoning***. <span style="color:red">[CCF-A]</span><br>Fangzhi Xu, Jun Liu, ***Qika Lin***, Yudai Pan and Lingling Zhang. [[Paper]](https://dl.acm.org/doi/10.1145/3477495.3532016) [[Code]](https://github.com/xufangzhi/Logiformer) 
- ```EMNLP 2022``` ***Inductive Relation Prediction with Logical Reasoning Using Contrastive Representations***. <span style="color:red">[CCF-B]</span><br>Yudai Pan, Jun Liu, Lingling Zhang, Tianzhe Zhao, ***Qika Lin***, Xin Hu, Qianying Wang. [[Paper]](https://aclanthology.org/2022.emnlp-main.286/) [[Code]](https://github.com/pyd418/LogCo) 
...
- ```Information Sciences 2021``` ***Rule-Enhanced Iterative Complementation for Knowledge Graph Reasoning***. <span style="color:red">[CCF-B]</span><br>***Qika Lin***, Jun Liu, Yudai Pan, Lingling Zhang, Xin Hu, Jie Ma. [[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S0020025521006319?via%3Dihub)
- ```FGCS 2021``` ***Improving University Faculty Evaluation via Multiview Knowledge Graph***. <span style="color:red">[CCF-C]</span><br>***Qika Lin‡***, Yifan Zhu‡, Hao Lu, Kaize Shi, Zhendong Niu. [[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S0167739X20330454?via%3Dihub)
- ```KBS 2021``` ***Recommending Scientific Paper via Heterogeneous Knowledge Embedding based Attentive Recurrent Neural Networks***. <span style="color:red">[CCF-C]</span><br>Yifan Zhu, ***Qika Lin***, Hao Lu, Kaize Shi, Ping Qiu, Zhendong Niu. [[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S0950705121000071?via%3Dihub)
